...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        nameTextField.setBounds(300, 140, 400, 30); // Fixed position
        add(nameTextField);
        ...
        fnameTextField.setBounds(300, 190, 400, 30); // Fixed position
        add(fnameTextField);
    ...
    public void actionPerformed(ActionEvent ae) {
       ...
       try {
    	   if(name.equals("")) {
    		   ...
    		   connec c = new connec();
    		   String query = "insert into signup values('"+formno+ "', '"+name+"', '"+fname+ "' , '"+dob+"' , '"+gender+"' , '"+email+"' , '"+martial+"','"+add+ "','"+city+ "' , '"+pin+ "' , '"+state+ "')";
